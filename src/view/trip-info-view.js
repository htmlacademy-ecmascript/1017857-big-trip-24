...
import { DateFormat, TRIP_DESTINATION_COUNT } from '../constants';
import { humanizeDueDate, sortByDay } from '../utilites/utils';
...
const getDateTemplate = (eventPoints) => {
  ...
  ${humanizeDueDate(datesStart[0], DateFormat.TRIP_INFO)}
  &nbsp;&mdash;&nbsp;
  ${humanizeDueDate(datesEnd[sortedEventPoints.length - 1], DateFormat.TRIP_INFO)}
  </p>
  `;
};
